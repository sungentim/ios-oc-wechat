...
#import "UIAlertView+SWCategory.h"
...
@implementation UIAlertView (SWCategory)
+ (instancetype)i_alertViewWithTitle:(NSString *)title
...
+ (instancetype)i_alertViewWithTitle:(NSString *)title
    ...
    return [self i_alertViewWithTitle:title
                       message:message
